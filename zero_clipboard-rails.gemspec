...
Gem::Specification.new do |gem|
  ...
  gem.summary       = 'Provides ZeroClipboard for Rails 3.1+'
  gem.description   = 'This gem provides the ZeroClipboard Javascript/Flash library for a Rails 3.1+ application.'
